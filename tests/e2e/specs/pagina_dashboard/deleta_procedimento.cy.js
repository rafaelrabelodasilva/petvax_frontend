describe('Deleta procedimento', () => {
    ...
    before(() => {
        ...
        cy.get('#petCard').contains('p#pet-name', 'Moon').should('exist');
    })

    it('Cadastro o novo procedimento', () => {
    ...
    it('Deleto o procedimento criado', () => {
        cy.get(':nth-child(1) > :nth-child(7) > [data-bs-target="#modalDeletaProced"] > .fa-regular').click()
    })
})